		...
		<div class="wrapper">
			...
			<div class="content">
				...
				<section class="data_insert">
					<form action="boardupdate_action" method="POST" class="totalForm">
						...
						<table width="100%">
							...
							<tr>
								<td><input type="text" name="user_nickname"
									value="${user_nickname}" class="default" readonly></td>
							</tr>
							<tr>
								<td>user_content</td>
							</tr>
							<tr>
								<td id="bottom"><textarea name="user_content" cols="53"
										rows="100">${user_content}</textarea></td>
							</tr>
